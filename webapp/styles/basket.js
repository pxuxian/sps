...
function modifyCartNumAdd(id) {
	window.location.href="/modifyCart.action?id="+ id + "&op=add"; 
}

function modifyCartNumDec(id) {
	window.location.href="/modifyCart.action?id="+ id + "&op=dec"; 
}
